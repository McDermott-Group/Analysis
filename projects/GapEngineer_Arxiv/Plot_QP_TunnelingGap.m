function [window_avg_psd, psd_freq] = Plot_QP_TunnelingGap(samples,CDdate, ...
...
%     trials = 5;
    ...
    path = strcat(['Z:\mcdermott-group\data\GapEngineer\', samples, CDdate,qubit, date, dataType,'\MATLABData']);
