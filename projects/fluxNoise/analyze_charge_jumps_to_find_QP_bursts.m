...
% trial_indicies       = [0, 0,  6,  4,  0,  0,  0,  0,  0,  2,  7,  2,  2,  0,  0,  0,  2,  6,  0,  6,  4,  0,  8,  5,  0,  0,  0,  6];
% rep_indicies         = [0,0,3314,1805,0,0,0,0,0,1231,1442,1152,3363,0,0,0,3001,872,0,1455,1746,0,171,2366,0,0,0,380];
>>>>>>> 1443dbd269446e10d2108afac78518bff1daf025
...
% %             (3) Plot autocorr, etc around that specific rep using user
% % list
...
%             (3) Plot autocorr, etc around that specific rep using auto
%             detection of event sites
>>>>>>> 1443dbd269446e10d2108afac78518bff1daf025
            if i <= length(rep_indicies)
                for j = 1:10
                    oj = o(j,:);
...
function [jump_idxs] = find_jump_indicies()
