...
# # for d in [ds.q1q2q4_0726_charge_T1, ds.q1q2q4_0727_charge_T1, ds.q1q2q4_0728_charge_T1,
          ...
          # # ds.q1q2q4_0801_charge_T1, ds.q1q2q4_0802_charge_T1]: # 30us duty cycle, 10us wait, Q1-Q2-Q4
# # for d in [ds.q1q4_0803_charge_T1, ds.q1q4_0805_charge_T1]: # 30us duty cycle, 10us wait, Q1-Q4 
# # for d in [ds.q1q2_0711_charge_T1, ds.q1q2_0714_charge_T1, ds.q1q2_0715_charge_T1,
            # # ds.q1q2_0719_charge_T1, ds.q1q2_0720_charge_T1, ds.q1q2_0722_charge_T1,
            # # ds.q1q2_0722_charge_T1_2, ds.q1q2_0724_charge_T1, ds.q1q2_0724_charge_T1_2,
            # # ds.q1q2_0725_charge_T1, ds.q1q4_0803_charge_T1, ds.q1q4_0805_charge_T1]: # 30us duty cycle, 10us wait, Q1-Q2, Q1-Q4
...
if False: whitelist = { 
              '07-11-20':[2166.7, 2858.0],
              '07-12-20':[ 775.0], # 515.1, 1590.1
              '07-13-20':[164.5, 934.1, 942.8,],
              '07-14-20':[47.6, 2397.4, 2402.1, 2953.0,
                          3680.6, 3903.2], # 1990.3, 2346.7, 2933.5, 3903.2
              # '07-15-20':[95.3, 100.8, 169.6, 232.8, 263.5, 664.0, 719.7], # 118.0,152.5,168.6,224.0,319.0
              # '07-16-20':[28.6, 59.2, 100.1, 158.7, 221.9, 349.0, 871.8, 1200.5], 
              '07-19-20':[32.0, 820.5, 846.4, 1183.1],
              '07-20-20':[538.4, 556.4, 910.8, 1352.3, 1463.5, 1528.1, 1681.8, 
                          2801.6],
              '07-21-20':[236.7, 493.7, 815.0, 1452.3, 
                          2263.9, 
                          2732.6, 739.4, 2316.4], # 1908.0
              '07-23-20':[271.6, 1069.3, 1334.3, 1467.6, 1830.0, 
                           1984.4, 2559.6, 2606.9, 2681.9],
              '07-24-20':[62.4, 107.5, 128.4, 367.5, 605.4, 627.6,
                          968.0, 973.9, 1154.1, 1271.5, 1315.5, 1354.5, 1753.7, 
                          1762.6, 1914.7, 2063.3, 2385.5, 2602.4],
              '07-25-20':[743.7, 1132.4,
                          1253.2, 1256.5, 1319.5,  2689.2],
              '07-26-20':[643.2, 662.4],
              '07-27-20':[978.9, 2098.1],
              '07-28-20':[296.4, 314.8, 1091.3, 
                          1711.9, 1898.1],
              '07-29-20':[53.4, 174.4, 702.0, 971.3, 997.5, 1067.0,
                          1366.0, 1798.1],
              '07-30-20':[994.5],
              '07-31-20':[123.4, 189.6, 724.0, 855.4,
                          2274.4], # 1753.4, 
              '08-01-20':[67.1, 231.8, 289.8, 
                          774.6, 782.1, 867.1], # 1079.6
                          
              '08-02-20':[300.3, 817.3, 928.1, 
                          1093.1, 1117.0, 1269.5], 
              '08-03-20':[84.1, 110.7, 320.6, 350.4, 363.6, 375.1, 460.1, 
                          552.7, 574.4, 692.4, 1141.6, 1184.7], 
              '08-04-20':[183.1, 254.7, 497.8, 532.7, 
                          692.4, 772.6, 1099.5, 1333.0, 
                          2089.1, 2121.4, 2168.5,
                           2451.8], 
              '08-05-20':[73.8, 920.7,
              
                          1010.2, 1153.1, 1175.7, 1511.1,
                          1901.4, 2104.8, 2106.8],
              '08-06-20':[201.4, 541.9, 1009.4, 
                          1308.6, 1375.8], 
              # '08-06-20':[356.6, 366.6, 721.5, 733.2, 746.4, 760.9, 763.8, 948.1], 
              # '08-07-20':[185.7, 266.1, 361.5, 495.3, 849.3, 942.0, 1012.0, 1055.7,
                          # 1093.0, 1292.3, 1343.8, 1354.4, 1403.0, 1858.5, 1893.7,
                          # 2317.5, 2350.0, 2512.1, 2535.4, 2535.9, 2570.4], 
              '08-10-20':[601.7, 662.1, 1571.6, 1610.0],
              '08-11-20':[95.8, 129.6, 542.5],
              '08-12-20':[35.6, 822.1],
              '08-13-20':[70.3, 880.9, 1016.2],
             }
# whitelist = None
...
for k,f in enumerate(files[:]): # 290
    ...
    DF.set_trigger_params(10000000., 500, 0.01)
    trials = None
