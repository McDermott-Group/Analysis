...
CO = ChargeOffset()
files = []
charge_path = ('fluxNoise2\DR1 - 2019-12-17\CorrFar\Q1Q2Q4Corr\General'
               '\Parameter\{}_correlation.hdf5')
path = 'Z:\\mcdermott-group\\data\\fluxNoise2\\DR1 - 2019-12-17\\CorrFar\\Q1Q2Q4Corr\\General\\{}\\{}\MATLABData\\'
...
# for d in [ds.q1q2_0711_charge_T1, ds.q1q2_0714_charge_T1, ds.q1q2_0715_charge_T1,
            ...
            # ds.q1q2_0725_charge_T1]: # 30us duty cycle, 10us wait
for d in [ds.q1q2q4_0727_charge_T1]: #new
...
# whitelist = { '06-03-20':[1288,1343,1669],
              ...
              # '07-22-20':[175.7, 7661.1], # 1908.0
              # '07-23-20':[1069.3, 1248.9, 1334.3, 1830.0, 2157.9],
              # '07-24-20':[367.5, 1354.5, 1914.7],
              # '07-25-20':[507.8, 545.7, 743.7, 1253.2, 1256.5, 1319.5],
              # '07-26-20':[180.9, 643.2],
              # '07-27-20':[],
             # }
...
print len(files)
for k,f in enumerate(files[150:]): # 93
