...
whitelist = None
whitelist = {'07-02-20': [1.4, 27.1, 113.2, 113.7, 197.7, 207.1, 263.6, 271.2, 331.0, 593.6],  # 161.8
             '07-03-20': [94.4, 130.9, 288.5, 358.6, 400.4, 406.6, 408.8, 446.1, 522.4, 672.0, 710.6, 720.1, 757.7, 869.8, 879.6, 883.5, 899.6, 901.5, 957.4, 981.0, 1017.4, 1025.8],
             '07-04-20': [4.4, 24.5, 42.1, 50.0, 116.0, 138.7, 168.7, 310.0, 362.5, 370.0, 388.3, 414.7, 430.5, 452.9, 460.5, 480.4, 552.0, 610.7, 718.1, 822.1, 876.3, 886.3, 906.2],
             '07-05-20': [134.1, 222.5, 250.4, 252.6, 268.8, 322.0, 328.2, 420.5, 446.8, 906.2],
...
print len(files_QP)
for k,f in enumerate(files_QP[:30]):
    path, num = noiselib.path_to_num(f)
    num = num + Q_A
    date = f.split('\\')[-4]
    ...
    DF.set_trigger_params(1000000., 300, 0.25)
    trials = None
