...
if 0:
    ...
    axs[0, 0].plot(f_Q2, eJ1*eQ2, color="purple", marker="o", markersize=4,
                label='Total')
    axs[0, 0].set_ylabel('Coupling Efficiency', color="black", fontsize=label_font)
    axs[0, 0].set_yscale('log')
    axs[0, 0].set_xlim([l_i, r_i])
    axs[0, 0].set_ylim([1e-6, 2e-1])
    axs[0, 0].tick_params(labelsize=tick_font)
    axs[0, 0].legend(loc=4, fontsize=legend_font)
    ...
    axs[1, 0].legend(loc=1, fontsize=legend_font)
...
if 0:
    ...
    axs[0].errorbar(Q2_P1[:, 0] * f_AWG, Q2_P1[:, 1] * 100,
                    yerr=Q2_P1[:, 2] * 100/ np.sqrt(100), label='$Q_{2}$', ecolor='k',
                    capthick=4, color='k')
    ...
    axs[1].plot([J * f_SIM for J in Q1_J1Bias], Q1_J1ParityRate, color='g', label='$Q_1$')
    axs[1].plot([J * f_SIM for J in Q2_J1Bias], Q2_J1ParityRate, color='k', label='$Q_2$')
    axs[1].plot([J * f_SIM for J in Q3_J1Bias], Q3_J1ParityRate, color='b', label='$Q_3$')
