...
for QB_id in QBs:
    ...
    for J7Bias in get_bias_list(QB_id):
        experiment_name_PSD = (QB_id+'_PSD_'+str(J7Bias)+'mVJ1')
        ...
        QPT_Q = QPTunneling_Harrison(name='{} with J7 = {} mV, {}GHz'.
        ...
        avg_fidelity, avg_parity, parity_uncertainty =plotFittedPSD_Harrison(QPT_Q, save=False, name='Zoomed Optimized {} with J7 ={} mV {}GHz'.
                                  format(QB_id, str(J7Bias), str(J7Bias*484)),excluded_points=ep, concatenate_records=cr)#, ylim=ylim)

        cr=get_cr(avg_parity)
        ep=2

        avg_fidelity, avg_parity, parity_uncertainty = plotFittedPSD_Harrison(QPT_Q, save=True,
                                                                              name='Zoomed Optimized {} with J7 ={} mV {}GHz'.
