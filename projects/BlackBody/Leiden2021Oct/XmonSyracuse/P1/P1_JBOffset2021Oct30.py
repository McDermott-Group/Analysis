...
### Z:\mcdermott-group\data\Antenna_Temporary\SUXmon\Liu\VitoChip1\P12021Oct30_Q123WithJ7\P1_J7_Q1_Chunk0\MATLABDataa
...
file_path = ('Z:/mcdermott-group/data/Antenna_Temporary/SUXmon/LIU/VitoChip1/{}/{}/MATLABData/{}')
date = 'P12021Oct30_Q123WithJ7'
file_Number = np.arange(0, 100, 1)
