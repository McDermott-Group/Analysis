...
for i in range(len(time)):
    d = [time[i], occ[i], error[i], occ_fit[i]]
    Q4_Up_1D_Data.append(d)
np.savetxt('2021Sep01CircRadiator_Q4_Up_1D_Data_283Bias.txt', Q4_Up_1D_Data)
# Q2_PSD_Data = []
...
#     Q3_PSD_Data.append(d)
# np.savetxt('Q3_PSD_Data.txt', Q3_PSD_Data)