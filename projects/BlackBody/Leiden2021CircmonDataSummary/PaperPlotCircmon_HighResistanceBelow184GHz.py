...
secax.set_xlabel("Transmitter Voltage Bias ($\Delta/e$)", fontsize=tick_font, labelpad=4)
...
plt.savefig('CircmonResistance.pdf', bbox_inches='tight', format='pdf', dpi=1200, transparent=True)
