...
plt.plot([1/T for T in Temp_array][:10], [0.06/T-7.5 for T in Temp_array][:10], label='QP_fit k=0.06')
plt.plot([1/T for T in Temp_array][10:38], [0.6/T-10.88 for T in Temp_array][10:38], label='QP_fit k=0.6')
plt.plot([1/T for T in Temp_array][38:], [3.96/T-18.9 for T in Temp_array][38:], label='QP_fit k=3.96')
