...
one_over_r_avg_geomean = 1.0 / (np.array([
    (r1in*r1out)**(1/2), (r2in*r2out)**(1/2), (r3in*r3out)**(1/2), (r4in*r4out)**(1/2)
]))
...
one_over_r_avg_geomean_norm = one_over_r_avg_geomean / np.mean(one_over_r_avg_geomean)
...
plt.plot(one_over_r_avg_geomean, label='1/r_geomean')
...
plt.plot(f_norm/one_over_r_avg_geomean_norm, label='Freq*r_geomean')
# plt.xlabel('J2 Freq (THz)')
# plt.ylabel('P1')
plt.grid()
plt.legend()
