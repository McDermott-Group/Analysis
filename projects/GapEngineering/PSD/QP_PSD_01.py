...
n = 100
date = '08-23-20'
QP_path = ('Z:/mcdermott-group/data/GapEngineer/Nb_GND_Dev06_Trap/Leiden_2020Jul/ChargeReset/LIU/Q4_withQ5Poison/{}/{}/MATLABData/{}')
QP_files = np.arange(0, n, 1)
files_none = np.arange(1,n/11+1,1)*11-1
QP_files = np.delete(QP_files, files_none)

# date = '08-16-20'
# experiment_name = ('QP_Tunneling_PSD_Poison_0dBm')
# # experiment_name = ('QP_Tunneling_PSD_Poison_On_0dBm')
# QP_0_filenames = [QP_path.format(date, experiment_name, experiment_name) + '_{:03d}.mat'.format(i) for i in QP_files]
# QP_0_psd = QP_PSD()
# QP_0_psd.add_data_from_matlab(QP_0_filenames)
# QP_0_psd.plot_PSD(fit=False)

experiment_name = ('QP_Tunneling_PSD_Poison_On_-2')
QP_Neg2_filenames = [QP_path.format(date, experiment_name, experiment_name) + '_{:03d}.mat'.format(i) for i in QP_files]
QP_Neg2_psd = QP_PSD()
QP_Neg2_psd.add_data_from_matlab(QP_Neg2_filenames)
QP_Neg2_psd.plot_PSD(fit=False)

experiment_name = ('QP_Tunneling_PSD_Poison_On_-4')
QP_Neg4_filenames = [QP_path.format(date, experiment_name, experiment_name) + '_{:03d}.mat'.format(i) for i in QP_files]
QP_Neg4_psd = QP_PSD()
QP_Neg4_psd.add_data_from_matlab(QP_Neg4_filenames)
QP_Neg4_psd.plot_PSD(fit=False)

experiment_name = ('QP_Tunneling_PSD_Poison_On_-6')
QP_Neg6_filenames = [QP_path.format(date, experiment_name, experiment_name) + '_{:03d}.mat'.format(i) for i in QP_files]
QP_Neg6_psd = QP_PSD()
QP_Neg6_psd.add_data_from_matlab(QP_Neg6_filenames)
QP_Neg6_psd.plot_PSD(fit=False)

experiment_name = ('QP_Tunneling_PSD_Poison_On_-8')
QP_Neg8_filenames = [QP_path.format(date, experiment_name, experiment_name) + '_{:03d}.mat'.format(i) for i in QP_files]
QP_Neg8_psd = QP_PSD()
QP_Neg8_psd.add_data_from_matlab(QP_Neg8_filenames)
QP_Neg8_psd.plot_PSD(fit=False)

experiment_name = ('QP_Tunneling_PSD_Poison_On_-10')
QP_Neg10_filenames = [QP_path.format(date, experiment_name, experiment_name) + '_{:03d}.mat'.format(i) for i in QP_files]
QP_Neg10_psd = QP_PSD()
QP_Neg10_psd.add_data_from_matlab(QP_Neg10_filenames)
QP_Neg10_psd.plot_PSD(fit=False)

# experiment_name = ('QP_Tunneling_PSD_Poison_On_-100')
# QP_Neg100_filenames = [QP_path.format(date, experiment_name, experiment_name) + '_{:03d}.mat'.format(i) for i in QP_files]
# QP_Neg100_psd = QP_PSD()
# QP_Neg100_psd.add_data_from_matlab(QP_Neg100_filenames)
# QP_Neg100_psd.plot_PSD(fit=False)

# date = '08-15-20'
# experiment_name = ('QP_Tunneling_PSD_Poison_Off')
# QP_Neg100_filenames = [QP_path.format(date, experiment_name, experiment_name) + '_{:03d}.mat'.format(i) for i in QP_files]
# QP_Neg100_psd = QP_PSD()
# QP_Neg100_psd.add_data_from_matlab(QP_Neg100_filenames)
# QP_Neg100_psd.plot_PSD(fit=False)
...
# f_QP = 56.0
# # f_RO = 0.99
# l = len(QP_0_psd.f_data)
    
fig = plt.figure()
# plt.loglog(QP_0_psd.f_data, QP_0_psd.Spp_avg, label='0 dBm')
plt.loglog(QP_Neg2_psd.f_data, QP_Neg2_psd.Spp_avg, label='Neg2 dBm')
plt.loglog(QP_Neg4_psd.f_data, QP_Neg4_psd.Spp_avg, label='Neg4 dBm')
plt.loglog(QP_Neg6_psd.f_data, QP_Neg6_psd.Spp_avg, label='Neg6 dBm')
plt.loglog(QP_Neg8_psd.f_data, QP_Neg8_psd.Spp_avg, label='Neg8 dBm')
plt.loglog(QP_Neg10_psd.f_data, QP_Neg10_psd.Spp_avg, label='Neg10 dBm')
# plt.loglog(QP_Neg100_psd.f_data, QP_Neg100_psd.Spp_avg, label='Off')
# plt.loglog(QP_0_psd.f_data, [19.5e-5]*l, label='19.5')
# plt.loglog(QP_0_psd.f_data, [20.5e-5]*l, label='20.5')
# plt.loglog(QP_0_psd.f_data, [9.75e-5]*l, label='9.75')
# plt.loglog(QP_0_psd.f_data, [10.25e-5]*l, label='10.25')
