...
# QPT_Q6_Poison_Dirty = QPTunneling_Liu(name='Q6_Dirty_P1>{} with poison={}'.format(P1, power))
QPT_Q6_Poison_Clean.add_datasets(PSD_Clean_Files, simulate=True)
# QPT_Q6_Poison_Dirty.add_datasets(PSD_Dirty_Files, simulate=True)

QPT_List = [QPT_Q6_Poison_Clean]
plotMultiFittedPSD(QPT_List)

p1_psd = [P1CleanDirty.clean_P1, P1CleanDirty.dirty_P1, QPT_Q6_Poison_Clean.T_parity, QPT_Q6_Poison_Dirty.T_parity]
print (power, p1_psd)