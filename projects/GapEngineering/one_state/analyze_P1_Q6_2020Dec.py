...
file_Q6_NoPoison = 'dfn1557wab_2020Dec07_P1_Parity_Interleave_Interleave_P1_Neg100.hdf5'
Q6_NoPoison = OneStateAnalyze()
Q6_NoPoison.one_state_data_retrieve(data_path, file_Q6_NoPoison)

file_Q6_Neg20dBm = 'dfn1622qxh_2020Dec08_P1_Parity_Interleave_Interleave_P1_Neg20.hdf5'
Q6_Neg20dBm = OneStateAnalyze()
Q6_Neg20dBm.one_state_data_retrieve(data_path, file_Q6_Neg20dBm)

file_Q6_Neg16dBm = 'dfn1627pdv_2020Dec09_P1_Parity_Interleave_Interleave_P1_Neg16.hdf5'
Q6_Neg16dBm = OneStateAnalyze()
Q6_Neg16dBm.one_state_data_retrieve(data_path, file_Q6_Neg16dBm)

file_Q6_Neg13dBm = 'dfn1629zhd_2020Dec09_P1_Parity_Interleave_Interleave_P1_Neg13.hdf5'
Q6_Neg13dBm = OneStateAnalyze()
Q6_Neg13dBm.one_state_data_retrieve(data_path, file_Q6_Neg13dBm)

file_Q6_Neg10dBm = 'dfn1555lhl_2020Dec07_P1_Parity_Interleave_Interleave_P1_Neg10.hdf5'
Q6_Neg10dBm = OneStateAnalyze()
Q6_Neg10dBm.one_state_data_retrieve(data_path, file_Q6_Neg10dBm)

# python to pandas
r_avg = 10  # rolling average
t = Q6_NoPoison.time_data[:2500]

f, ax = plt.subplots(5, 2)

ax[0][0].plot(t, Q6_NoPoison.get_rolling_data_pre(r_avg)[0][:2500], label='No Poison')
ax[0][0].set_title('Q6 P1 Time Trace')

ax[1][0].plot(t, Q6_Neg20dBm.get_rolling_data_pre(r_avg)[0][:2500], label='Neg 20 dBm')
ax[2][0].plot(t, Q6_Neg16dBm.get_rolling_data_pre(r_avg)[0][:2500], label='Neg 16 dBm')
ax[3][0].plot(t, Q6_Neg13dBm.get_rolling_data_pre(r_avg)[0][:2500], label='Neg 13 dBm')
ax[4][0].plot(t, Q6_Neg10dBm.get_rolling_data_pre(r_avg)[0][:2500], label='Neg 10 dBm')
...
bin_list = np.arange(0.05, 0.2, 0.002)
