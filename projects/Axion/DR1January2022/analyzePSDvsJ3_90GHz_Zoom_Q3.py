...
J3Biaslist= list(np.arange(131000,206501,500))#list(np.arange(0,72500,500))+
start_file = 0
num_files =10
# J3Biaslist = [40, 42, 44]
fparity = {}
...
for QB_id in QBs:
    ...
    for J3Bias in J3Biaslist:
        ...
        experiment_name_PSD1 = '90GHz_Zoom_PSD_{}uDAC_JB3_Q3'.format(str(J3Bias))
        if J3Bias < 72500:
            date='02-27-22'
        else:
            date='03-02-22'
        PSD_file_Number = np.arange(start_file, start_file + num_files, 1)
        PSD_file = [QP_path.format(date, experiment_name_PSD1, experiment_name_PSD1) + '_{:03d}.mat'.format(i) for i in PSD_file_Number]
        QPT_Q = QPTunneling_Harrison(name='{} with J3 = {} uDAC'.
        ...
        avg_fidelity, avg_parity, parity_uncertainty =plotFittedPSD_Harrison(QPT_Q, save=True, name='000000{} with J3 ={} uDAC'.
