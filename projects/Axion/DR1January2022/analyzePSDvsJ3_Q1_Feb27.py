...
J3Biaslist= [0]#list(np.arange(-300,700,20))
start_file = 20
num_files =5
# J3Biaslist = [40, 42, 44]
fparity = {}
...
for QB_id in QBs:
    ...
    for J3Bias in J3Biaslist:
        ...
        experiment_name_PSD1 = 'SingleTestPSD_0mDAC_JB2_0mA_Flux2_Q2_NoChargeBias'
        experiment_name_PSD2 = 'SingleTestPSD_0mDAC_JB2_0mA_Flux2_Q2_NoChargeBias'
        ...
        avg_fidelity, avg_parity, parity_uncertainty =plotFittedPSD_Harrison(QPT_Q, save=True, name='005{} with J3 ={} mDAC {}GHz'.
