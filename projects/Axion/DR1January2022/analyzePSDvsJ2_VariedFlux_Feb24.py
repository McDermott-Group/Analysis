...
J3Biaslist=np.arange(-3600,3601,200)#np.arange(-300,700,20)
start_file = 0
num_files =10
# J3Biaslist = [40, 42, 44]
fparity = {}
...
for QB_id in QBs:
    ...
    if QB_id=='Q4':
        ylim=[10 ** (-5), 10 ** (-3)]
    for J3Bias in J3Biaslist:
        experiment_name_PSD1 = ('TestPSD_464mDAC_JB2_{}uA_Flux2_{}'.format(str(J3Bias),str(QB_id)))
        experiment_name_PSD2 = ('TestPSD_464mDAC_JB2_{}uA_Flux2_{}'.format(str(J3Bias),str(QB_id)))
        ...
        avg_fidelity, avg_parity, parity_uncertainty =plotFittedPSD_Harrison(QPT_Q, save=True, name='0000 Biased {} with J3 ={} mDAC {}GHz'.
...
plt.title('Parity Rate vs J2 Flux')
plt.xlabel('J2 Radiator Flux Bias (uA)')
