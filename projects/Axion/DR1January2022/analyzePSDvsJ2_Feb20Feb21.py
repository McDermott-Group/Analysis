...
J3Biaslist20=list(np.arange(-308,706,20))+list(np.arange(-298,706,20))+list(np.arange(-303,396,20))
J3Biaslist21 =list(np.arange(-293,706,20))+list(np.arange(437,706,20))
...
for QB_id in QBs:
    filtered_freq = []
    filtered_parity = []
    for i,bias in enumerate(J3Biaslist20+J3Biaslist21):
