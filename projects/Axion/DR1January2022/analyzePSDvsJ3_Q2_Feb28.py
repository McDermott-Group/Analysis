...
J3Biaslist= list(np.arange(-300,700,20))
start_file = 0
num_files =10
# J3Biaslist = [40, 42, 44]
fparity = {}
...
for QB_id in QBs:
    ...
    for J3Bias in J3Biaslist:
        ...
        experiment_name_PSD1 = ('PSD_{}mDAC_JB3_{}'.format(str(J3Bias),str(QB_id)))
        ...
        avg_fidelity, avg_parity, parity_uncertainty =plotFittedPSD_Harrison(QPT_Q, save=True, name='00008{} with J3 ={} mDAC {}GHz'.
