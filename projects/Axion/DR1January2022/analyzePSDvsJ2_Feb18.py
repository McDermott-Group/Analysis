...
J2Biaslist=list(np.arange(-1000,1001,200))
start_file = 0
num_files =10
# J2Biaslist = [40, 42, 44]
fparity = {}
...
for QB_id in QBs:
    ...
    if QB_id=='Q4':
        ylim=[10 ** (-5), 10 ** (-3)]
    for J2Bias in J2Biaslist:
        experiment_name_PSD1 = ('Test4PSD_'+str(J2Bias)+'mVJB2_'+QB_id+'_Narrow')
        experiment_name_PSD2 = ('Test4PSD_' + str(J2Bias) + 'mVJB2_' + QB_id + '_Narrow')
