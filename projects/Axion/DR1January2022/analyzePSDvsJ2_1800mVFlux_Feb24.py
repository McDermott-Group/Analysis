...
J3Biaslist=np.arange(595,700,20)#np.arange(-300,700,20)
start_file = 0
num_files =10
# J3Biaslist = [40, 42, 44]
fparity = {}
...
for QB_id in QBs:
    ...
    if QB_id=='Q4':
        ylim=[10 ** (-5), 10 ** (-3)]
    for J3Bias in J3Biaslist:
        experiment_name_PSD1 = ('TestPSD_{}mDAC_JB2_-1800mV_Flux2_{}'.format(str(J3Bias),str(QB_id)))
        experiment_name_PSD2 = ('TestPSD_{}mDAC_JB2_-1800mV_Flux2_{}'.format(str(J3Bias),str(QB_id)))
