...
%steadyStateModelFit2NIS04212016 Fitting to the `TrapNoTrap` dataset using
...
r_direct = 1.127e-04; r_phonon_n = 3.069e-01; r_phonon_f = 9.030e-02; c = 9.030e-02; vol = 2.600e+04;
...
P_sim_n = NaN(size(V_sim_n));
P_sim_f = NaN(size(V_sim_f));
