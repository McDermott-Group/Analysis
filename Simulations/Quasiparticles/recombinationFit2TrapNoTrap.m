...
r_direct_no_tr = 1e-6; % in units of 1 / \tau_0 %(assuming n_{qp} in units of n_{cp})
r_phonon_no_tr = 1e-9; % in units of 1 / \tau_0 %(assuming n_{qp} in units of n_{cp})
c_no_tr = 0; % trapping rate in units of 1 / \tau_0

r_direct_tr =  1e-6; % in units of 1 / \tau_0 %(assuming n_{qp} in units of n_{cp})
r_phonon_tr = 1e-9; % in units of 1 / \tau_0 %(assuming n_{qp} in units of n_{cp})
