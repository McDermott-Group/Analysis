...
%extractKappa(sw_prob) Extract cavity kappa using
% two data sets: switching probability vs Readout Amplitude and Swiching
...
[filenames, pathnames, status] = selectMeasurementDataFile(2,...
    {['Select the first data file containing Swiching Probability vs ',...
     'Readout Amplitude...'],...
     ['Select the second data file containing Swtiching Probability vs',...
