...
if isfield(data.error, 'JPM_A_Switching_Probability')
    errorbar(data.(data.rels.JPM_A_Switching_Probability{1}), data.JPM_A_Switching_Probability,...
        1.96 * data.error.JPM_A_Switching_Probability, 'r.', 'LineWidth', 1, 'MarkerSize', 15)
end
if isfield(data.error, 'JPM_B_Switching_Probability')
    errorbar(data.(data.rels.JPM_B_Switching_Probability{1}), data.JPM_B_Switching_Probability,...
        1.96 * data.error.JPM_B_Switching_Probability, 'b.', 'LineWidth', 1, 'MarkerSize', 15)
end
