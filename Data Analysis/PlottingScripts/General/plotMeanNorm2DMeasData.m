function data = plotMeanNorm2DMeasData(normalization_direction,...
    data_variable)
%plotMeanNorm2DMeasData(NORMALIZATION_DIRECTION, DATA_VARIABLE) Plot
...
if length(dep_rels) == 2 
    if strcmp(normalization_direction, 'along_y')
        dep_vals = dep_vals ./ (mean(dep_vals, 2) *...
